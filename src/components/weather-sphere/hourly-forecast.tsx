        ...
        >
          <CarouselContent className="-ml-2">
            {data.hourly.map((item, index) => (
              <CarouselItem key={`${item.time}-${index}`} className="basis-1/4 md:basis-1/5 lg:basis-1/4 pl-2">
                <div className="flex flex-col items-center space-y-2 p-3 rounded-lg bg-background/30 flex-shrink-0 transition-all duration-200 ease-in-out hover:bg-background/50 hover:scale-105 min-w-[80px]">
