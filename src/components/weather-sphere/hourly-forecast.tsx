      ...
      <CardContent>
        <div className="flex space-x-4 overflow-x-auto pb-4 no-scrollbar">
          {data.hourly.map((item, index) => (
            <div key={`${item.time}-${index}`} className="flex flex-col items-center space-y-2 p-3 rounded-lg bg-background/30 flex-shrink-0 transition-all duration-200 ease-in-out hover:bg-background/50 hover:scale-105 min-w-[80px]">
