      ...
      <CardContent>
        ...
        >
            ...
            {data.hourly.map((item, index) => (
                <CarouselItem key={index} className="basis-1/4 sm:basis-1/5 md:basis-1/6 pl-1">
                    <div className={cn(
                        "flex flex-col items-center justify-between gap-1 p-2 rounded-lg text-center h-full transition-all duration-200 ease-in-out",
